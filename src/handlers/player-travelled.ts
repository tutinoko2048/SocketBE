...
import { NetworkHandler, type PlayerTravelledPacket, type Connection } from '../network';
...
export class PlayerTravelledHandler extends NetworkHandler {
  ...
  public handle(packet: PlayerTravelledPacket, connection: Connection): void {
    ...
    const { player: rawPlayer, metersTravelled, isUnderwater, newBiome, travelMethod } = packet;
